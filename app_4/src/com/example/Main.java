...
public class Main {
    ...
    static ArrayList<User> readSerializedFile(){
        ...
        try
        {
            ...
            ObjectInputFilter filesOnlyFilter = ObjectInputFilter.Config.createFilter("java.util.ArrayList<>;com.example.User;!*");
            in.setObjectInputFilter(filesOnlyFilter);

            users = (ArrayList)in.readObject();
            //Employee empread= (Employee)in.readObject();

            //ois.setObjectInputFilter(new CustomClassFilter());
